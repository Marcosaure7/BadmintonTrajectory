...
class BadmintonTrajectory:
    ...
    def __init__(self, vitesse_ini, angle_verticale, dt):
        """
        ...
        """
        self.calculer_traj(vitesse_ini, angle_verticale, dt)

    def calculer_traj(self, vitesse_ini, angle_verticale, dt):
        ...
        pos_x, pos_y = -1.98, 1.55  # Position initiale (côté joueur, hauteur standard)
...
def optimize_trajectory(distance_atterissage, hauteur_au_filet=None, liste_Points_2D=None):
    """
    Optimise la trajectoire d'un volant de badminton pour passer par des points cibles.

    Args:
        distance_atterissage (float): Distance cible d'atterrissage en mètres
    ...
    distance_atterissage = min(distance_atterissage, 7.36)  # Limite à la longueur du court
